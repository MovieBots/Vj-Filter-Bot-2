...
auth_channel = environ.get('AUTH_CHANNEL', '-1002001028091') # give your force subscribe channel id here else leave it blank
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'botts')
